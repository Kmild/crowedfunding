...
public class CrowdFileUploadUtil {
     ...
     */
    public static MessageForResponce<String> uploadFileToOSS(
        ...
        try {
            ...
            if (responseMessage == null) {
                ...
                // 当前方法返回成功
                return MessageForResponce.ReturnMessageWithSuccess("ok", ossFileAccessPath);
            } else {
                // 获取响应状态码
                ...
                // 当前方法返回失败
                return MessageForResponce.ReturnMessageWithFail(" 当 前 响 应 状 态 码 =" + statusCode + " 错 误 消 息 =" + errorMessage);
            }
        } catch (Exception e) {
            e.printStackTrace();
            // 当前方法返回失败
