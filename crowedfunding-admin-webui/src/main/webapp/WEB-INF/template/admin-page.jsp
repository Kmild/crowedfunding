...
<script type="text/javascript">
    ...
    function pageSelectCallback(pageIndex, jQuery) {
        ...
        // 执行页面跳转也就是实现“翻页”  el表达式隐藏参数： param  使用： param.请求参数名
        window.location.href = "admin/do/page.html?pageNum=" + pageNum+"&keyword=${param.keyword}";
        // 取消当前超链接的默认行为
        return false;
    }
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="admin/to/admin-add.html" class="btn btn-primary" style="float:right;">
...
<%--                                            修改--%>
                                            <a href="admin/to/edit/${admin.id}.html" class="btn btn-primary btn-xs">
                                                <i class=" glyphicon glyphicon-pencil"></i>
                                            </a>
<%--                                                        删除--%>
                                               <a href="admin/do/remove/${admin.id}/${requestScope.pageInfo.pageNum}/${param.keyword}.html" id="remove_a" class="btn btn-danger btn-xs">
